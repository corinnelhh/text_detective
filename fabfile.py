...
def _install_supervisor():
    ...
    sudo('mv supervisord.conf /etc/supervisor/conf.d/text_detective.conf')
...
def _move_nginx_files():
    ...
    sudo('mv text_detective/simple_nginx_config /etc/nginx/sites-available/default')
...
def _mass_install():
    ...
    with settings(warn_only=True):
        sudo('pip install -r text_detective/requirements.txt')
